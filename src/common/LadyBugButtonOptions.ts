...
export const LIGHT_SURFACE_TEXT_FILL = LadyBugColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link LadyBugColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: LadyBugColors.controlSurfaceColorProperty,
  listFill: LadyBugColors.controlSurfaceColorProperty,
  buttonStroke: LadyBugColors.panelBorderColorProperty,
  listStroke: LadyBugColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: LadyBugColors.textColorProperty },
  },
